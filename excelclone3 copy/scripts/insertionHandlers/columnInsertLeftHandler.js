export default class ColumnInsertLeftHandler {
    constructor(grid) {
        this.grid = grid;
        this.hoveredCol = null;
        this.isActive = false; // Is mouse over the circle?
    ...
    handleMouseMove(event) {
        ...
        // Only active in the column header area
    ...
    hitTest(mousePos) {
        ...
        return { colIndex: this.hoveredCol }; // Return info about the hit
    }
    ...
    handleMouseDown(event, onComplete, hitResult) {
        ...
        this.grid.insertColumns(hitResult.colIndex, count, width);
        onComplete();
    }
